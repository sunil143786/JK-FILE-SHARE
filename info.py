...
BOT_TOKEN = environ.get('BOT_TOKEN', "7121730083:AAGGdzngEge8KbEJrvG5kSV-BHJduXsvLpA")
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6445840990').split()]
